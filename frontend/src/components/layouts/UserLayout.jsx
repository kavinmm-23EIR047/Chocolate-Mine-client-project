      ...
      <div className="bg-[#4E2820] dark:bg-[#E8D3CB] py-2 px-4 sm:px-6 lg:px-8 overflow-hidden transition-colors duration-300">
        ...
        <div className="flex md:hidden items-center justify-between w-full gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <img src={PureVegIcon} alt="100% Pure Veg" className="w-4 h-4 object-contain shrink-0" />
          </div>

          {/* Center: Delivery */}
          <div className="flex items-center gap-1.5 text-[#F2E2DB] dark:text-[#120806] text-[10px] font-black uppercase tracking-[0.08em] mx-1">
            <Truck size={14} className="shrink-0 text-[#F2E2DB] dark:text-[#120806]" />
            <span>3Hrs Delivery in CBE</span>
          </div>

          {/* Right: Phone Call Number & Icon links */}
          <div className="flex items-center gap-3 shrink-0 text-[#4ade80] dark:text-[#4E2820]">
            <a href="tel:+919150670077" className="flex items-center gap-1 hover:text-white dark:hover:text-[#120806] transition-colors">
              ...
              <span className="font-black tracking-tight text-[10px]">+91 91506 70077</span>
            </a>
